...
Finite-horizon optimal control is a popular method for computing predictive control strategies for dynamical systems~\cite{Reilly2013b,Bayen2006}, its applicability growing with the increase of computational power and pervasiveness of physical sensing. In general, a finite-horizon optimal control problem will take the following form:
...
\centering
  ...
  \includegraphics[width=.35\columnwidth]{previous-articles/admm/figures/dep-graph}%
  } \hfill
...
A common application of finite-horizon optimal control is in the context of model predictive control (MPC)~\cite{Reilly2013b,Frejo2011}, where optimal control policies are recomputed in a \emph{rolling-horizon} fashion. Given the optimal control problem beginning at a time-step $t$,
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.9\columnwidth]{previous-articles/admm/figures-lowres/bcScen/spacetime}
